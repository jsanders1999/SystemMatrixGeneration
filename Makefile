...
MAIN_GMRES_OBJ=main_gmres_poisson.cpp gmres_solver_cart.o operations.o timer.o 
MAIN_DIAGG_OBJ=main_gmres_poisson.cpp gmres_solver_cart.o operations.o timer.o
MAIN_POLYG_OBJ=main_gmres_poisson.cpp polygmres_solver_cart.o operations.o timer.o
MAIN_DIAGG_OBJ=main_gmres_poisson.cpp gmres_solver_win.o operations.o timer.o
MAIN_POLYG_OBJ=main_gmres_poisson.cpp polygmres_solver_win.o operations.o timer.o
